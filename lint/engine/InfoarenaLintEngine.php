...
final class InfoarenaLintEngine extends ArcanistLintEngine {
    ...
    public function buildLinters() {
        ...
        // This needs to go first so that changes to generated files cause
        // module linting. This linter also operates on removed files, because
        // removing a file changes the static properties of a module.
