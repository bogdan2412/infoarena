...
// Call this function whenever you want to make sure a feature is disabled
// because of integration with infoarena.
function ia_disabled() {
    // Feature disabled for integration with infoarena
    log_print('This feature was disabled for integration with infoarena.');
    log_backtrace();
    die();
}
