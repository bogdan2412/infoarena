...
$txt['go_to_your_forum'] = 'Acum poţi vedea <a href="%s">forumul tău proaspăt instalat</a> şi să începi să-l utilizezi. Mai întâi asigură-te că eşti autentificat, după care poţi accesa Centru de Administrare.';
...
$txt['default_board_description'] = 'Eşti liber să vorbeşti despre orice în acest forum.';
...
$txt['default_theme_name'] = 'SMF Tema Implicită - Tema de Bază';
...
$txt['default_newbie_group'] = 'Începător';
$txt['default_junior_group'] = 'Junior';
$txt['default_full_group'] = 'Membru deplin';
$txt['default_senior_group'] = 'Senior';
$txt['default_hero_group'] = 'Erou';

$txt['default_smiley_smiley'] = 'Zâmbet';
$txt['default_wink_smiley'] = 'Face cu ochiul';
$txt['default_cheesy_smiley'] = 'Cheesy';
$txt['default_grin_smiley'] = 'Rânjet';
$txt['default_angry_smiley'] = 'Mânios';
$txt['default_sad_smiley'] = 'Trist';
$txt['default_shocked_smiley'] = 'Şocat';
$txt['default_cool_smiley'] = 'Grozav';
$txt['default_huh_smiley'] = 'Huh?';
$txt['default_roll_eyes_smiley'] = 'Clipeşte';
$txt['default_tongue_smiley'] = 'Limbă';
$txt['default_embarrassed_smiley'] = 'Jenat';
$txt['default_lips_sealed_smiley'] = 'Buze sigilate';
$txt['default_undecided_smiley'] = 'Nehotărât';
$txt['default_kiss_smiley'] = 'Sărut';
$txt['default_cry_smiley'] = 'Plânge';
$txt['default_evil_smiley'] = 'Rău';
$txt['default_azn_smiley'] = 'Azn';
$txt['default_afro_smiley'] = 'Afro';

$txt['error_message_click'] = 'Click aici';
$txt['error_message_try_again'] = 'pentru a încerca această etapă din nou.';
$txt['error_message_bad_try_again'] = 'pentru a încerca să instalezi oricum, dar atenţie: este <i>total</i> nerecomandat.';

$txt['install_settings'] = 'Setări de Bază';
...
$txt['install_settings_compress_info'] = 'Această funcţie nu rulează corect pe toate serverele, dar te poate ajuta să salvezi multă bandă.<br />Click <a href="install.php?obgz=1&amp;pass_string=PASS" onclick="return reqWin(this.href, 200, 60);" target="_blank">aici</a> pentru a testa. (ar trebui doar să spună "PASS".)';
$txt['install_settings_dbsession'] = 'Înregistrează sesiunile în baza de date';
$txt['install_settings_dbsession_title'] = 'Foloseşte baza de date pentru sesiuni în loc să foloseşti fişiere.';
...
$txt['install_settings_utf8_info'] = 'Această facilitate permite ca baza de date şi datele să folosească setul de caractere internaţional UTF-8. Aceasta poate fi folositoare atunci când se lucrează cu mai multe limbi care utilizează seturi de caractere diferite.';
...
$txt['mysql_settings_password_info'] = 'Aici scrie parola necesară pentru a te conecta la baza de date MySQL.<br />Dacă nu o stii, încearcă parola de la contul FTP.';
...
$txt['mysql_settings_prefix_info'] = 'Prefixul care urmează a fi utilizat pentru tabelele forumului SMF.  <b>Niciodată nu instala doua forumuri cu acelaşi prefix!</b><br />Această valoare permite multiple instalări într-o singură bază de date.';

$txt['user_settings'] = 'Creează contul tău';
$txt['user_settings_info'] = 'Interfaţa va crea acum un nou cont de administrator pentru tine!';
$txt['user_settings_username'] = 'Numele tău de utilizator';
$txt['user_settings_username_info'] = 'Alege numele cu care vrei să te autentifici.<br />Acesta nu poate fi schimbat mai târziu, însă numele afişat poate fi.';
...
$txt['user_settings_database_info'] = 'Interfaţa cere această parolă pentru baza de date, pentru a crea contul de administrator, din motive de securitate.';
...
$txt['ftp_username_info'] = 'Numele de utilizator cu care te autentifici. <i>Acesta nu va fi salvat nicăieri.</i>';
...
$txt['error_mysql_too_low'] = 'Versiunea MySQL care este utilizată pe server este foarte veche şi nu îndeplineşte condiţiile minime necesare de către SMF.<br /><br />Te rugăm să ceri gazdei fie să instaleze o versiune mai nouă, fie să-ţi acorde un alt server, dacă nu doreşte încearcă un server gazdă diferit.';
...
$txt['error_session_missing'] = 'Interfaţa de instalare a fost incapabilă să detecteze suport pentru sesiuni în instalarea PHP pe server. Te rugăm să anunţi administratorul serverului gazdă că PHP a fost compilat cu session support (în fapt, trebuie să fie compilat în mod explicit fară.)';
$txt['error_user_settings_again_match'] = 'Ai scris două parole complet diferite!';
