...
$txt['membergroups_new_board'] = 'Secţiuni vizibile';
$txt['membergroups_new_board_desc'] = 'Secţiuni vizibile pentru grupul de utilizatori';
$txt['membergroups_new_board_post_groups'] = '<em>Notă: în mod normal, grupurile bazate pe numărul de mesaje nu au nevoie să le setezi permisiuni deoarece alte grupuri ale căror utilizatori sunt le dau utilizatorilor drepturi de acces sau le introduc restricţii după caz.</em>';
$txt['membergroups_new_as_type'] = 'după tip';
$txt['membergroups_new_as_copy'] = 'alege de bază';
$txt['membergroups_new_copy_none'] = '(niciuna)';
$txt['membergroups_can_edit_later'] = 'Poţi modifica acestea mai târziu.';
...
$txt['membergroups_online_color'] = 'Culoarea în lista utilizatorilor online';
...
$txt['membergroups_members_no_members'] = 'Acest grup nu are niciun utilizator în acest moment';
...
$txt['admin_browse_approve'] = 'Utilizatori care aşteaptă aprobarea conturilor';
$txt['admin_browse_approve_desc'] = 'Aici poţi administra toţi utilizatorii care au conturi în aşteptarea aprobării.';
...
$txt['admin_browse_awaiting_approval'] = 'Aşteaptă aprobarea  <span style="font-weight: normal">(%d)</span>';
$txt['admin_browse_awaiting_activate'] = 'Aşteaptă activarea <span style="font-weight: normal">(%d)</span>';

$txt['admin_browse_username'] = 'Nume de utilizator';
$txt['admin_browse_email'] = 'Adresa de email';
$txt['admin_browse_ip'] = 'Adresa IP';
$txt['admin_browse_registered'] = 'Înregistrat';
$txt['admin_browse_id'] = 'ID';
$txt['admin_browse_with_selected'] = 'Cu cei selectaţi';
$txt['admin_browse_no_members_approval'] = 'Niciun membru nu aşteaptă aprobarea.';
$txt['admin_browse_no_members_activate'] = 'Niciun membru nu este neactivat.';
...
$txt['admin_browse_w_approve_require_activate'] = 'Aprobă şi aşteaptă activarea';
...
$txt['admin_approve_reject'] = 'Înregistrare refuzată';
...
$txt['admin_approve_delete_desc'] = 'Contul tău în ' . $context['forum_name'] . ' a fost şters. Aceasta s-a întâmplat deoarece nu ai activat niciodată contul; în acest caz poţi încerca să te înregistrezi din nou.';
$txt['admin_approve_remind'] = 'Reaminteşte înregistrarea';
$txt['admin_approve_remind_desc'] = 'Încă nu ai activat contul tău din ';
