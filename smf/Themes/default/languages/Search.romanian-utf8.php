...
$txt[344] = 'Oricare cuvant să se regaseasca în rezultat';
$txt[583] = 'de către utilizatorul';

$txt['search_post_age'] = 'Vârsta mesajului';
...
$txt['search_orderby_relevant_first'] = 'Cele mai relevante întăi';
$txt['search_orderby_large_first'] = 'Cele mai mari subiecte întăi';
$txt['search_orderby_small_first'] = 'Cele mai mici subiecte întăi';
$txt['search_orderby_recent_first'] = 'Cele mai recente subiecte întăi';
$txt['search_orderby_old_first'] = 'cele mai vechi subiecte întăi';
...
$txt['simpleSearch'] = 'Activează căutare simplă';
$txt['search_results_per_page'] = 'Număr de rezultate ale căutarii pe pagină';
$txt['search_weight_frequency'] = 'Importanţa relativ la numărul de coincidenţe într-un subiect';
$txt['search_weight_age'] = 'Importanţa relativ la vârsta ultimului mesaj care se potriveşte';
$txt['search_weight_length'] = 'Importanţa relativ la lungimea subiectului';
$txt['search_weight_subject'] = 'Importanţa relativa la gradul de coincidenţa a subiectului';
$txt['search_weight_first_message'] = 'Importanţa relativ la gradul de potrivire al primului mesaj';
$txt['search_weight_sticky'] = 'Importanţa relativ la un subiect important (sticky)';
...
$txt['search_weights_title'] = 'Cautăre - relevanţa';
...
$txt['search_method_no_index_exists'] = 'în acest moment nu exista';
...
// This string is used în a javascript confirmation popup; don't use entities.
...
// This string is used în a javascript confirmation popup; don't use entities.
$txt['search_index_custom_warning'] = 'Pentru a putea utiliza un index de căutare personalizat trebuie mai întăi să-l creezi!';

$txt['search_force_index'] = 'Obligă pe toti să utilizeze indexul de căutare';
...
$txt['search_create_index_not_ready'] = 'SMF creează în acest moment un index de căutare prin mesaje. Pentru a evita supraincarcarea serverului procesul a fost momentan întrerupt. Ar trebui să continue automat în cateva secunde. Dacă nu se reia apasă click mai jos.';
