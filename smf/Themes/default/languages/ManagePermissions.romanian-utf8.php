...
$txt['permissions_switch'] = 'Schimbă în';
$txt['permissions_global'] = 'Global';
$txt['permissions_local'] = 'Local';

$txt['permissions_groups'] = 'Permisiuni per grupuri de utilizatori';
$txt['permissions_all'] = 'toate';
$txt['permissions_none'] = 'niciuna';
...
$txt['permissions_copy_from_board'] = 'Copiază permisiunile de la acest forum';
...
$txt['permissions_remove'] = 'Şterge permisiunea';
$txt['permissions_deny'] = 'Interzice permisiunea';
$txt['permissions_select_permission'] = 'Selectează o permisiune';

// All of the following block of strings should not use entities, instead use \\" for &quot; etc.
$txt['permissions_only_one_option'] = 'Poţi selecta doar o acţiune pentru a modifica permisiunile';
...
$txt['permissionhelp_search_posts'] = 'Permisiunea Caută permite utilizatorilor să caute în toate forumurile în care au acces. Când permisunea de Căutare este activată, un buton \'Caută\' va fi adăugat în bara de butoane a forumului.';
$txt['permissionname_karma_edit'] = 'Schimbă popularitatea altor utilizatori.';
$txt['permissionhelp_karma_edit'] = 'Karma este o funcţie care afişează popularitatea unui utilizator. Pentru a activa această funcţie, trebuie să fie activată în \'Opţiuni şi Facilităţi\'. Această permisiune permite unui grup de utilizatori să voteze o dată. Nu are efect pentru Vizitatori.';

$txt['permissiongroup_pm'] = 'Mesagerie personală';
$txt['permissionname_pm_read'] = 'Citeşte mesajele personale';
...
$txt['permissionhelp_calendar_view'] = 'Calendarul afişează pentru fiecare lună aniversările, evenimentele şi sărbătorile. Această permisiune conferă accesul la Calendar. Când este activată, un buton va fi adăugat la bara de butoane de sus şi o listă va fi afişată în josul paginii principale a forumului cu evenimentele, aniversările şi sărbătorile imediat următoare. Calendarul trebuie să fie activat în \'Editează Facilităţi şi Opţiuni\'.';
$txt['permissionname_calendar_post'] = 'Creează evenimente în calendar';
$txt['permissionhelp_calendar_post'] = 'Un eveniment este un subiect legat la o anumită dată sau perioadă. Crearea de evenimente poate fi făcută din Calendar. Un eveniment poate fi creat doar dacă acel utilizator are permisiunea de a scrie noi subiecte.';
$txt['permissionname_calendar_edit'] = 'Editează evenimente în calendar';
$txt['permissionhelp_calendar_edit'] = 'Un eveniment este un subiect legat la o anumită dată sau perioadă. Evenimentele pot fi editate făcând click pe asteriskul roşu (*) de lângă eveniment când se afişează calendarul. Pentru a edita un eveniment, un utilizator trebuie să aibă permisiuni suficiente pentru a edita primul mesaj dintr-un subiect legat la acel eveniment.';
...
$txt['permissionname_manage_attachments'] = 'Organizează fişierele ataşate şi avatarele';
$txt['permissionhelp_manage_attachments'] = 'Această permisiune conferă acces la centrul de administrare al fişierelor ataşate, unde toate fişierele ataşate şi avatarele sunt listate şi pot fi şterse.';
$txt['permissionname_manage_smileys'] = 'Organizează zâmbetele';
$txt['permissionhelp_manage_smileys'] = 'Aceasta permite accesul la centrul de administrare al zâmbetelor. Aici se pot crea, adăuga şi elimina seturile de zâmbete.';
...
$txt['permissionhelp_manage_bans'] = 'Acestă permisiune dă dreptul unui utilizator să adauge sau să elimine un ban în lista, un utilizator sau o adresa IP, hostname şi adresa de email. De asemenea îi este permis să vizualizeze logul de utilizatori banaţi care încearcă să se autentifice.';
...
$txt['permissionhelp_profile_server_avatar'] = 'Dacă este permis, acest lucru va da posibilitatea utilizatorilor să aleagă un avatar din colecţia de pe server.';
$txt['permissionname_profile_upload_avatar'] = 'Încarcă un avatar pe server';
...
$txt['permissionhelp_profile_remote_avatar'] = 'Deoarece avatarul influenţează durata de creare a unei pagini, este posibil să nu permiţi unor utilizatori să foloseasca avatarei de pe servere externe.';
...
$txt['permissionhelp_post_new'] = 'Această permisiune dă dreptul utilizatorilor să scrie subiecte noi. Nu le permite să răspundă la subiecte.';
$txt['permissionname_merge_any'] = 'Lipeşte orice subiect';
$txt['permissionhelp_merge_any'] = 'Lipeşte două sau mai multe subiecte în unul singur. Ordinea mesajelor în subiectul rezultat va fi în ordinea datei şi orei la care au fost create. Un utilizator poate lipi mesaje doar din forumuri unde îi este permis să citească. Pentru a lipi mesajele, utilizatorul trebuie să-şi activeze moderarea rapidă în setările din profilul personal.';
$txt['permissionname_split_any'] = 'Împarte orice subiect';
$txt['permissionhelp_split_any'] = 'Împarte un subiect în două subiecte separate.';
...
$txt['permissionname_make_sticky'] = 'Marchează subiecte drept importante (sticky)';
...
$txt['permissionhelp_lock'] = 'Acestă permisiune conferă unui utilizator dreptul de a bloca un subiect. Aceasta acţiune poate fi făcută pentru ca nimeni să nu mai poată răspunde la un subiect. Doar utilizatorii cu \'Moderează forum\' au posibilitatea de a scrie mesaje în subiecte blocate.';
...
$txt['permissionhelp_remove'] = 'Şterge subiectele cu totul. Atenţie: această permisiune nu permite ştergerea de mesaje într-un subiect anume!';
...
$txt['permissionhelp_post_reply'] = 'Această permisiune permite răspunsul la subiecte.';
...
$txt['permissionhelp_delete'] = 'Elimină mesajele. Aceasta nu permite unui utilizator să şteargă primul mesaj dintr-un subiect.';
...
$txt['permissionhelp_report_any'] = 'Acestă permisiune adaugă un link la fiecare mesaj, permiţând unui utilizator să raporteze un mesaj la moderator(i). Astfel, toţi moderatorii acelui forum vor primi un mail cu un link către mesajul rapotat şi o descriere a problemei (aşa cum este dată de utilizatorul care raportează).';

$txt['permissiongroup_poll'] = 'Sondaje';
$txt['permissionname_poll_view'] = 'Vizualizează sondaje';
$txt['permissionhelp_poll_view'] = 'Aceasta permite unui utilizator să vadă sondajele dintr-un subiect. Fără aceasta el va vedea doar subiectul.';
$txt['permissionname_poll_vote'] = 'Votează în sondaje';
$txt['permissionhelp_poll_vote'] = 'Această permisiune dă dreptul unui utilizator înregistrat să voteze o dată. Nu se aplică la vizitatori.';
$txt['permissionname_poll_post'] = 'Porneşte sondaje';
$txt['permissionhelp_poll_post'] = 'Această permisiune dă dreptul unui utilizator să iniţieze un sondaj nou.';
...
$txt['permissionhelp_poll_remove'] = 'Această permisiune permite eliminarea de sondaje.';
...
$txt['permissionhelp_mark_notify'] = 'Notificările la subiecte noi sunt o facilitate care permite unui utilizator să primească email de fiecare dată când un nou subiect este creat într-un forum unde sunt înscrişi.';
...
$txt['permissionname_post_attachment'] = 'Ataşează fişiere';
...
$txt['permission_settings_desc'] = 'Aici poţi seta cine are dreptul de a altera permisiunile celorlalţi, precum şi cât de sofisticat este sistemul de permisiuni.';
$txt['permission_settings_enable_postgroups'] = 'Activează permisiunile bazate pe numărul de mesaje scrise';
// Escape any single quotes in here twice.. 'it\'s' -> 'it\\\'s'.
$txt['permission_disable_postgroups_warning'] = 'Dezactivând aceasta vei elimina permisiunile acordate în acest moment grupurilor pe baza numărului de mesaje scrise.';
