...
$txt['pm_error_data_limit_reached'] = 'Mesajul nu a putut fi trimis către \'%s\' deoarece acesta are căsuţa plină!';
...
$txt['pm_labels_desc'] = 'Aici poţi adăuga, edita şi şterge etichetele folosite în căsuţa de mesaje personale.';
$txt['pm_label_add_new'] = 'Adaugă o eticheta';
$txt['pm_label_name'] = 'Numele etichetei';
$txt['pm_labels_no_exist'] = 'În acest moment nu ai setată nicio etichetă!';
...
$txt['pm_report_admins'] = 'Administratori la care le trimiţi mesajul';
...
$txt['pm_report_done'] = 'Mulţumim pentru că ai raportat aceste mesaje personal. Vei avea un răspuns de la echipa de adminstratori căt mai curănd.';
$txt['pm_report_return'] = 'Întoarce-te la Mesaje primite';
...
$txt['pm_search_orderby_relevant_first'] = 'Cele mai relevante întâi';
$txt['pm_search_orderby_recent_first'] = 'Cele mai recente întâi';
$txt['pm_search_orderby_old_first'] = 'Cele mai vechi întăi';

$txt['pm_visual_verification_label'] = 'Verificare';
$txt['pm_visual_verification_desc'] = 'Pentru a trimite acest mesaj personal trebuie să introduci codul vizual din imaginea de mai sus.';
