...
$txt['manual_index_visit_simple_machines'] = 'Vizitează site-ul Simple Machines!';

// Entries for template: smf.
$txt['manual_smf_user_help'] = 'SMF - Ajutor pentru utilizatori';

// Entries for template: index.
$txt['manual_index_intro'] = 'Introducere';
$txt['manual_index_register'] = 'Inregistrare';
$txt['manual_index_login'] = 'Autentificare';
$txt['manual_index_profile'] = 'Profil';
$txt['manual_index_posting'] = 'Cum se trimite un mesaj';
$txt['manual_index_pm'] = 'Mesaje Personale';
$txt['manual_index_search'] = 'Cautăre';
...
$txt['manual_index_you_have_arrived_part3'] = ' sau un ecran care îţi spunea ca trebuie să te inregistrazi inainte de a putea citi şi te intrebai ce ai de facut în continuare?';
$txt['manual_index_guest_permit_read_part1'] = 'Ei bine, unele forumuri permit vizitatorilor să scrie şi să citeasca mesaje, altele doar să citeasca, altele sunt restricitonate doar la utilizatorii înregistraţi. Noi îţi recomandam să ';
$txt['manual_index_guest_permit_read_link_registering'] = 'inregistrare';
$txt['manual_index_guest_permit_read_part2'] = ' la fiecare forum pe care îl folosesti cu regularitate deoarece cele mai multe facilitati devin accesibile doar atunci. Deoarece SMF este un sistem foarte flexibil astfel incat doua forumuri au putine sanse de a fi identice, noi vom incepe prin a descrie patru zone cheie care în mod normal vor fi intotdeauna acolo pentru tine:';
$txt['manual_index_main_menu'] = 'Meniul Principal';
$txt['manual_index_suppossing_guest'] = 'Presupunand ca ai ajuns aici ca vizitator (sau eşti inregistrat insa nu eşti autentificăt), meniul principal ar trebui să aiba în mod normal cinci sau sase butoane (sau link-uri text):';
$txt['manual_index_home_desc_part1'] = '<strong>Acasa</strong>, care te duce înapoi la pagina de inceput ';
...
$txt['manual_index_search_desc_part1'] = '<strong>Cautăre</strong>, care îţi permite să ';
$txt['manual_index_search_desc_link_searching'] = 'cauti';
$txt['manual_index_search_desc_part2'] = ' prin forum dupa orice doresti sau vrei să afli.';
...
$txt['manual_index_login_desc_part1'] = '<strong>Intrare</strong>, care îţi permite să te ';
$txt['manual_index_login_desc_link_loginout'] = 'autentifici';
$txt['manual_index_login_desc_part2'] = ' dacă deja te-ai inregistrat.';
...
$txt['manual_index_register_desc_part2'] = ' (sau uneori să aplici pentru o inregistrare) atunci cand doresti să faci asta.';
$txt['manual_index_once_registered'] = 'Odata inregistrat şi autentificăt, meniul principal ar trebui să arate un pic diferit:';
$txt['manual_index_home_reg'] = '<strong>Acasa</strong> (ca mai sus).';
$txt['manual_index_help_reg'] = '<strong>Ajutor</strong> (ca mai sus).';
$txt['manual_index_search_reg'] = '<strong>Cautăre</strong> (ca mai sus).';
$txt['manual_index_profile_reg_part1'] = '<strong>Profil</strong>, care îţi permite să-ţi modifici ';
$txt['manual_index_profile_reg_link_profile'] = 'profilul';
$txt['manual_index_profile_reg_part2'] = ' setările.';
$txt['manual_index_calendar_reg'] = '<strong>Calendar</strong> (ca mai sus).';
$txt['manual_index_logout_reg_part1'] = '<strong>Iesire</strong>, care îţi permite să ';
$txt['manual_index_logout_reg_link_loginout_logout'] = 'iesi';
$txt['manual_index_logout_reg_part2'] = ' din nou dacă doresti.';
$txt['manual_index_forum_admins_note_presentation'] = 'Administratorii forumului vor avea deasemenea un buton aditional <strong>Admin</strong> button.';
$txt['manual_index_sec_board_index'] = 'Pagina de Index a forumului';
$txt['manual_index_sec_board_index_def'] = 'While the board index (forum home page) is packed with all kinds of information and links, the core of the interface (at least în the SMF default theme) normally looks something like this:';
...
$txt['manual_index_topics_posts'] = 'Number of topics and posts în this board';
...
$txt['manual_index_n_no_n_posts'] = 'The <strong>New Posts</strong> and <strong>No New Posts</strong> icons în the leftmost column show registered members whether there have been any new posts to the board since they last read it.';
$txt['manual_index_m_read'] = 'The <strong>Mark as Read</strong> button enables registered members to mark all posts în the entire forum as \'read\'.';
...
$txt['manual_index_nav_tree'] = 'Some forums show the <strong>navigation tree</strong> at the top în a space-saving horizontal mode.';
...
$txt['manual_index_mark_read_button'] = 'The <strong>Mark as Read</strong> button enables registered members to mark all posts în this board as \'read\'.';
$txt['manual_index_notify_button'] = 'The <strong>Notify</strong> button enables registered members to subscribe to email notification of replies to topics în this board.';
$txt['manual_index_new_topic_poll_button_part1'] = 'The <strong>New Topic</strong> and <strong>New Poll</strong> buttons are for starting new topics and polls, as described în the ';
...
$txt['manual_index_topic_icons'] = 'The <strong>topic icons</strong> în the leftmost column are explained by the key below.';
$txt['manual_index_post_icons'] = 'The <strong>post icons</strong> în the next column are sometimes used to draw attention to the mood or purpose of the topic.';
...
$txt['manual_index_navigation_tree'] = 'Some forums show the <strong>navigation tree</strong> at the top în a space-saving horizontal mode.';
...
$txt['manual_index_author_details'] = 'The <strong>author details</strong> în the lefthand column may be accompanied by further personal information.';
...
$txt['manual_loginout_complete_reg_part2'] = ' process, you will be able to login to the site for the first time. After that, you can choose whether to stay logged în indefinitely or logout at the end of your visit.';
$txt['manual_loginout_sec_login'] = 'Logging In';
$txt['manual_loginout_login_desc'] = 'So you might be newly registered or you might simply have been logged out from a previous visit, but there\'s normally a choice between the login screen and the quick login în either case.';
...
$txt['manual_loginout_login_screen_desc_part2'] = ') is not only where you\'ll normally be taken on completing registration but also the first thing you\'ll see în any \'members only\' forum, we will describe it first:';
...
$txt['manual_loginout_login_screen_explanation'] = 'While the <strong>Username</strong> and <strong>Password</strong> fields should be self-explanatory, <strong>Minutes to stay logged in</strong> simply means the number of minutes the cookie that keeps you logged în will last before expiring and requiring you to login again. So it\'s not advisable to enter a long time here if you share a computer and are likely to forget to logout, but you might prefer to check <strong>Always stay logged in</strong> if no-one else has access to your computer.';
$txt['manual_loginout_sub_quick_login'] = 'The Quick Login';
$txt['manual_loginout_although_many_forums_part1'] = 'Although many forums also have a quick login box to allow you to login direct from any screen, its position on the page may vary considerably from forum to forum. In the SMF default theme, for example, it\'s în the collapsable section at the top, whereas it\'s more likely to be at the bottom în themes based on the older YaBB SE forum. If you can\'t see it and it hasn\'t simply been collapsed, it\'s either not enabled at all (in which case you should still be able to access the login screen from the ';
$txt['manual_loginout_although_many_forums_link_index_main'] = 'main menu';
$txt['manual_loginout_although_many_forums_part2'] = ') or you\'re already logged în (in which case the main menu should include a <strong>Logout</strong> rather than <strong>Login</strong> link!).';
...
$txt['manual_loginout_logout_desc_part1'] = 'When you have finished browsing the forum, you may decide to logout. Perhaps you share a workstation with someone else, în which case leaving yourself logged în would not be a good idea. So select the <strong>Logout</strong> option from the ';
...
$txt['manual_loginout_reminder_explanation'] = 'You can enter either your username or your email address so long as you check the appropriate option, then click the <strong>Send</strong> button to send yourself an email containing a link to reset your password. It\'s also possible to avoid the email altogether if you\'ve set yourself a secret question and answer în your profile, but please beware of questions that anyone could answer or guess (like \'what is the first color of the rainbow?\', which would be a very bad choice)!';

// Entries for template: pm.
$txt['manual_pm_community'] = 'SMF is about community and communication. And there are many ways to communicate, such as posting to the boards, personal messaging, email, ICQ, AIM and YIM. But SMF\'s own personal message system, as available to registered members în most forums, is sometimes a more suitable option than any of these.';
$txt['manual_pm_sec_pm'] = 'Personal Messaging';
$txt['manual_pm_pm_desc'] = 'Description';
$txt['manual_pm_pm_desc_1'] = 'While email is a good way to correspond directly with members, it also has several drawbacks for forum purposes: you must open your email application to write and send the message, the recipient must open his/her email application and check his/her mail, your message will be mixed în with all the other mail and it can sometimes take several minutes to an hour for mail to reach the recipient.';
...
$txt['manual_pm_pm_desc_3'] = 'If a recipient isn\'t online, personal messages wait în the member\'s PM box until the next time he/she logs în and reads and/or deletes them. SMF Personal Messages is a self-contained, highly private email system.';
...
$txt['manual_pm_pm_desc2_part1'] = 'The PM interface is similar în operation to that of the ';
$txt['manual_pm_pm_desc2_link_index_message'] = 'message index';
$txt['manual_pm_pm_desc2_part2'] = '. While we are showing the inbox interface here, the outbox works în much the same way:';
$txt['manual_pm_forum_name'] = 'Forum Name';
$txt['manual_pm_personal_msgs'] = 'Personal Messages';
$txt['manual_pm_inbox'] = 'Inbox';
$txt['manual_pm_delete'] = 'Delete all messages în your Inbox';
...
$txt['manual_pm_nav_tree'] = 'Some forums show the <strong>navigation tree</strong> at the top în a space-saving horizontal mode.';
$txt['manual_pm_delete_button'] = 'The main <strong>Delete</strong> button deletes all messages în your inbox (or outbox if open). Note that the checkbox and lower <strong>Delete</strong> button also allow you to delete selected messages, with the top checkbox selecting all.';
...
$txt['manual_pm_msg_link_part2'] = ', x are new\', then click the <strong>New Message</strong> button în your inbox.';
...
$txt['manual_pm_click_pm_icon_part1'] = 'You can start a new message direct by clicking the <strong>PM on/offline</strong> icon from the <strong>Current Status</strong> în his/her ';
$txt['manual_pm_click_pm_icon_link_profile_info-all'] = 'profile';
$txt['manual_pm_click_pm_icon_part2'] = ' summary screen. (This icon/link is often duplicated în the user info described above.)';
...
$txt['manual_posting_forum_about_part1'] = 'Since posting messages is basically what forums are all about, we will spend some time looking at the various options and techniques available. Those who are familiar with forum software, HTML or bulletin board code în general may prefer to skip straight to the ';
...
$txt['manual_posting_please_note'] = '<strong>Please note that, because an SMF forum may be customized extensively by its administrator(s), the presence of a feature în this documentation does not necessarily mean that it will be available to all users în all forums.</strong>';
$txt['manual_posting_sec_posting_basics'] = 'Posting Basics';
$txt['manual_posting_starting_topic'] = 'Starting a New Topic';
$txt['manual_posting_starting_topic_desc_part1'] = 'Browse to the board where you wish to post and click the <strong>New Topic</strong> button (positioned by default at both the top and the bottom of the board, as shown în the ';
...
$txt['manual_posting_nav_tree'] = 'Some forums show the <strong>navigation tree</strong> at the top în a space-saving horizontal mode.';
...
$txt['manual_posting_replying_desc_part2'] = ', but it\'s not necessary to enter anything în the <strong>Subject</strong> field unless you wish to change what\'s already there. To vote în a poll, you simply have to select your chosen option(s) and click <strong>Submit Vote</strong>.';
...
$txt['manual_posting_quote_desc'] = 'To reply to a post by quoting it, you can either click the <strong>Quote</strong> button for the relevant post and add your own message to the quoted text or click the <strong>Reply</strong> button followed by <strong>Insert Quote</strong> from the relevant post în the \'Topic Summary\' below, but note that:';
...
$txt['manual_posting_quote_independant_part1'] = 'You can also retain or add the \'author\' attribute independently of the full <strong>Quote</strong> function, as demonstrated în the ';
...
$txt['manual_posting_bbc_desc'] = 'Bulletin Board Code (or BBC) is the essential tool for formatting and changing the appearance of your post. While it affects the plain text în much the same way as the formatting tools în any word processor, the main <strong>Message</strong> field does not behave în a WYSIWYG manner, so you should preview your message if you need to see what it will look like when posted.';
...
$txt['manual_posting_smiley_desc_part1'] = 'While smileys can be viewed as purely whimsical în nature, they can also play a valuable role în clarifying the written word în much the same way as vocal inflections and/or facial expressions clarify the spoken word. Like most forum software, SMF provides a standard range of smiley images which can be added to posts by clicking the relevant icons or typing the relevant codes. A ';
...
$txt['manual_posting_tags_desc_part2'] = ' and their purposes, let\'s see how they work by imagining that we want to post some text în bold type. While we can start by clicking the <strong>B</strong> (Bold) button and typing our text between the tags it produces, it\'s often more practical to type the text first, highlight it and then click the button. So typing \'text\', highlighting it and clicking the \'B\' button should produce \'[b]text[/b]\', which renders as <b>text</b> when posted or previewed. (NB This doesn\'t work în Opera, which inserts the tags at the end of the post.) Subsequently highlighting \'[b]text[/b]\' and clicking the <strong>I</strong> (Italicized) button will produce \'[i][b]text[/b][/i]\', which not only renders as <i><b>text</b></i> when posted or previewed but also introduces the concept of nesting, which means that each new set of tags în a case like this should be seen as a new \'box\' containing both the original text <em>and</em> any tags already applied to it.';
...
$txt['manual_posting_sec_additional_options_desc'] = 'The following options may appear by default în some forums but be contained within an expanding/collapsing panel (try clicking the link with the arrow below!) în others:';
...
$txt['manual_posting_return_desc'] = 'Check this to return to the topic (instead of the message index) after posting (NB you can also set this behaviour as a preference în your profile).';
...
$txt['manual_posting_no_smiley_desc_part2'] = ' în your post from being parsed and rendered as smileys.';
$txt['manual_posting_sub_attach'] = 'Attachments';
$txt['manual_posting_attach_desc_part1'] = 'If enabled, this feature allows you to attach files to your posts în much the same way as most email clients, so you simply have to browse to the relevant file(s) on your computer before clicking <strong>Post</strong>. You can delete your attachment(s) or add more by ';
...
$txt['manual_posting_glow_comment'] = 'The three attributes (eg red, 2, 50) în the \'glow\' tag are color, strength and width respectively.';
...
$txt['manual_posting_shadow_comment'] = 'The two attributes (eg red, left) în the \'shadow\' tag are color and direction respectively.';
...
$txt['manual_posting_pre_comment'] = 'Preserves critical text formatting, rendered în a monospace font.';
...
$txt['manual_posting_rtl_comment'] = 'Typical usage would be to post Arabic or Hebrew în an English document.';
...
$txt['manual_posting_ltr_comment'] = 'Typical usage would be to post English în an Arabic or Hebrew document.';
...
$txt['manual_posting_flash_comment'] = 'Please note that, if embedded Flash has been disabled by the forum administrator(s), the Flash file will appear as a straight hyperlink as shown here. The two attributes în the \'flash\' tag (where relevant) are width and height respectively.';
...
$txt['manual_posting_url_comment'] = 'NB the \'url\' tag opens în a new window, but you can type \'iurl\' tags to open în the same window.';
...
$txt['manual_profile_profile_screen'] = 'The profile screen în the default theme normally consists of a single main pane, with an additional menu to the left to lead you through the editing options for your own profile. Please note that, because an SMF forum may be customized extensively by its administrator(s), the features and user permissions described here are typical rather than definitive.';
...
$txt['manual_profile_current_date_time'] = 'Current date and time în member\'s time zone';
...
$txt['manual_profile_empty_part1'] = 'The fields left empty here are not filled în by default, so you should ';
...
$txt['manual_profile_sub_track_user'] = '<strong>Track User</strong> provides a list of <strong>IP numbers</strong> used by the member, other members who might be în the same <strong>IP range</strong> and <strong>error messages</strong> generated/experienced by the member.';
...
$txt['manual_profile_sub_ban_user'] = '<strong>Ban this user</strong> provides tools for <strong>banning</strong> users, configuring the <strong>level</strong> of the ban and maîntăining a <strong>ban list</strong> noting the details of any bans în force.';
...
$txt['manual_registering_you_have_arrived_part1'] = 'When you have set up your SMF forum, or wish to join another SMF forum, you should register a username. This will enable you to maîntăin a consistent identity while posting and keep track of what you\'ve read, no matter where you\'re working from or what computer you\'re using. You\'ll be able to fill out a personal ';
...
$txt['manual_registering_select_register_part1'] = 'Any page of the forum, în which you case you should select <strong>Register</strong> from the ';
$txt['manual_registering_select_register_link_index_main'] = 'main menu';
$txt['manual_registering_select_register_part2'] = '.';
$txt['manual_registering_login_Scr_part1'] = 'A login screen headed by a warning about access being restricted to registered members, în which case you should either use the registration link provided or select <strong>Register</strong> from the ';
...
$txt['manual_registering_email_activate'] = 'If registration has been configured to require email activation, the next screen will tell you so and you should receive an immediate email with instructions about how to proceed. But there\'s also a useful link (\'Did you miss your activation email?\') în the <strong>User Info</strong> box în case you miss this email or mistype your email address.';
...
$txt['manual_searching_search_desc_part1'] = 'Assuming the forum is running the SMF default theme (or a derivative of it), there should be both a simple <strong>Search</strong> field (partnered by an <strong>Advanced search</strong> text link) în the collapsable top section and a <strong>Search</strong> option în the ';
...
$txt['manual_searching_quotes_desc'] = 'To put this în a nutshell, searching for <strong>simple machines forum</strong> will return any or all of these three words, but enclosing the search string în <em>double</em> quote marks (ie <strong>"simple machines forum"</strong>) will return only the entire phrase.';
...
$txt['manual_searching_nav_tree'] = 'Some forums show the <strong>navigation tree</strong> at the top în a space-saving horizontal mode.';
...
$txt['manual_searching_search_button'] = 'The <strong>Search</strong> button not surprisingly sets the whole thing în motion, but hitting \'Enter\' direct from any of the search fields is sometimes more convenient.';
