...
$txt[141] = 'Dat fiind caracterul public al forumului poate sunt cuvinte pentru care doresti să împiedici afişarea lor de către utilizatori. Poţi introduce mai jos orice cuvânt ce doreşti a fi cenzurat indiferent dacă este sau nu folosit de un utilizator.<br />Şterge casuţa pentru a elimina cuvăntul.';
$txt[207] = 'Nume de utilizator rezervate';
$txt[216] = 'Editează fişierele Template ale forumului';
$txt[222] = 'Setări pentru server';
$txt[338] = 'Trimite un e-mail la urmatoarea lista de e-mail-uri';
$txt[341] = 'Seteaza numele rezervate';
$txt[342] = 'Un nume rezervat pe fiecare linie.';
$txt[347] = 'Aceasta pagina iţi permite să modifici setarile de bază pentru forum. Fii foarte atent la aceste setari, atata timp cât pot duce la nefuncţionare forumului. ';
$txt[348] = 'Mod intreţinere?';
$txt[350] = 'Numele forumului';
$txt[351] = 'Adresă forumului';
...
$txt[424] = 'Optiuni de administrare SMF';
$txt[426] = 'Utilizatori';
$txt[427] = 'Principal';
$txt[428] = 'Configurare';
...
$txt[740] = 'Afisează butoanele BBC când se postează sau se trimit mesaje personale?';

$txt['smf1'] = 'Eroare la efectuarea backup-ului fişierului Settings.php - asigura-te ca Settings_bak.php exista şi poate fi suprascris (are atributul writable).';
...
$txt['smf5'] = 'Serverul pe care este ţinuta baza de date:';
$txt['smf6'] = 'Utilizator baza de date:';
$txt['smf7'] = 'Parola utilizatorului ataşat la baza de date';
$txt['smf8'] = 'Nume baza de date:';
$txt['smf11'] = 'Agreement pentru înregistrare';
$txt['smf12'] = 'Acesta agreement este afişat atunci când un nou utilizator se înregistreaza în forum şi trebuie să fie acceptat înainte de a continua înregistrarea.';
$txt['smf54'] = 'Prefixul ales pentru tabelele din baza de date:';
$txt['smf55'] = 'Ţine apasată tasta Ctrl pentru selecţie multiplă.  Apasă butonul ' . $txt[17] . ' când ai terminat.';
...
$txt['smf201'] = 'Fişiere ataşate şi avataruri';
$txt['smf202'] = 'Aici poţi administra fişierele ataşate. Poţi şterge ataşamentele după mărime sau după data. Alte statistici despre fişierele ataşate sunt de asemenea afişate mai jos.';
...
$txt['smf207'] = 'Optiununi pentru fişierele ataşate';
...
$txt['smf283'] = 'Incerc să optimizez baza de date...';
$txt['smf284'] = 'Optimizez ..... %1$s... %2$f kb optimizati.';
$txt['smf285'] = 'Toate tabelele sunt deja optimizate.';
$txt['smf285b'] = 'Nu este necesar să optimizez nici o tabela.';
...
$txt['smf320'] = 'Atenţie - fişierul agreement.txt nu poate fi scris, orice schimbare care o faci NU va fi salvata.';
...
$txt['lfyi'] = 'Nu a fost posibilă conectarea la pagina simplemachines.org\'s pentru a afla ultimile anunţuri.';

$txt['manage_calendar'] = 'Calendar';
$txt['manage_search'] = 'Cautare';

$txt['smileys_manage'] = 'Zămbete şi imagini ataşate mesajelor';
$txt['smileys_manage_info'] = 'Instalează un nou set de zămbete, adauga zămbete la un set deja existent şi organizeaza icoanele mesajelor.';
$txt['package1'] = 'Pachete de modificări';
$txt['package_info'] = 'Instalează o noua facilitate sau modifică una existentă folosind aceasta interfaţă.';
...
$txt['email_as_html'] = 'Trimite în format HTML.  (folosind aceasta poţi pune HTML în email.)';
...
$txt['email_force'] = 'Trimite aceasta la membri chiar dacă ei au ales să nu primeasca anunţuri.';
...
$txt['ban_log_remove_all_confirm'] = 'Eşti sigur ca vrei să ştergi toate înregistrarile din logul de banuri?';
$txt['ban_log_remove_selected'] = 'Elimină cele selectate';
$txt['ban_log_remove_selected_confirm'] = 'Eşti sigur ca vrei să ştergi înregistrarile selectate din logul de banuri?';
$txt['ban_no_triggers'] = 'Nu exista criterii de interzicere';
...
$txt['filter_only_session'] = 'Afişează doar mesajele de eroare din aceasta sesiune';
...
$txt['maintain_general'] = 'Intreţinere generala';
$txt['maintain_recount'] = 'Recontorizeaza toate statisticile şi alte totaluri în forum.';
...
$txt['maintain_return'] = 'Inapoi la întreţinerea forumului';
...
$txt['repair_stats_topics_3'] = 'Subiectul #%d are un numar greşit de raspunsuri, %d.';
...
$txt['repair_missing_log_topics'] = 'Subiectul #%d este marcat ca citit de catre unul sau mai multi utilizatori, dar nu există.';
$txt['repair_missing_log_topics_members'] = 'Utilizatorul #%d a marcat unul sau mai multe subiecte ca citite, dar nu există.';
$txt['repair_missing_log_boards'] = 'Forumul #%d este marcat ca citit de catre unul sau mai multi utilizatori, dar nu există.';
$txt['repair_missing_log_boards_members'] = 'Utilizatorul #%d a marcat ca citite unul sau mai multe forumuri, dar nu există.';
$txt['repair_missing_log_mark_read'] = 'Forumul #%d este marcat ca citit de unul sau mai multi oameni, dar nu există.';
...
$txt['repair_missing_senders'] = 'Mesajul Personal #%d a fost trimis de catre utilizatorul #%d, care nu există.';
$txt['repair_missing_notify_members'] = 'Notificări au fost cerute de către utilizatorul #%d, care nu există.';
...
$txt['repair_missing_log_poll_vote'] = 'Un vot a fost facut de catre utilizatorul #%1$d în sondajul inexistent #%2$d.';
...
$txt['modlog_search'] = 'Căutare Rapida';
$txt['modlog_by'] = 'de către';

$txt['smileys_default_set_for_theme'] = 'Selecteaza setul de zămbete implicit pentru această tema';
$txt['smileys_no_default'] = '(foloseşte setul de zămbete implicit global)';
...
$txt['membergroups_stars'] = 'Steluţa';
...
$txt['mods_cat_avatars'] = 'Avataruri';
...
$txt['avatar_max_height_external'] = 'Înăltimea maximă a unui avatar extern';
$txt['avatar_action_too_large'] = 'Daca avatarul este prea mare...';
...
$txt['option_download_and_resize'] = 'Download şi redimensionare locală (necesita modulul GD)';
$txt['avatar_max_width_upload'] = 'Lăţimea maximă pentru avatar încărcat';
$txt['avatar_max_height_upload'] = 'Înăltimea maximă pentru avatar încărcat';
...
$txt['repair_attachments'] = 'Intreţinere fişiere ataşate';
$txt['repair_attachments_complete'] = 'Intreţinere completă';
...
$txt['repair_attachments_error_desc'] = 'Următoarele erori au fost găsite în timpul intreţinerii. Bifează casuţa de lângă eroarea pe care o doreşti a repara şi apoi apasă Continuă.';
$txt['repair_attachments_continue'] = 'Continuă';
$txt['repair_attachments_cancel'] = 'Anulează';
$txt['attach_repair_missing_thumbnail_parent'] = '%d thumbnailuri au lipsă fişierul ataşat părinte';
$txt['attach_repair_parent_missing_thumbnail'] = '%d fişiere părinte sunt marcate ca având un thumbnails insă nu au';
$txt['attach_repair_file_missing_on_disk'] = '%d fişiere ataşate/avata au o intrare în baza de date dar ele nu mai există pe server';
$txt['attach_repair_file_wrong_size'] = '%d fişiere ataşate şi/sau avataruri sunt raportate cu dimensiune a fişierului greşita';
$txt['attach_repair_file_size_of_zero'] = '%d fişiere ataşate şi/sau avataruri au dimensiunea pe disk egală cu zero biţi. (Acestea vor fi şterse)';
...
$txt['groups_edit_news'] = 'Grupuri care le permiti să editeze ştirile';
$txt['groups_send_mail'] = 'Grupuri la care le permiti să trimita scrisori cu ştiri la forum';
$txt['xmlnews_enable'] = 'Activează ştiri sub forma de feed XML/RSS';
$txt['xmlnews_maxlen'] = 'Dimensiunea maximă a mesajului: <div class="smalltext">(0 pentru a dezactiva, nu e o idee buna.)</div>';
...
$txt['permission_mode_reply_only'] = 'Doar raspunsuri';
$txt['permission_mode_read_only'] = 'Doar citit';

$txt['update_available'] = 'Update Disponibil!';
$txt['update_message'] = 'Foloseşti o versiune veche de SMF! Aceasta conţine unele erori care au fost corectate.
	Este recomandat să <a href="" id="update-link">aduci la zi forumul</a> la ultima versiune cat mai curand posibil. Va dura doar cateva minute!';
...
$txt['manageposts_topic_settings_description'] = 'Aici poţi seta totul în ce priveste subiectele.';
$txt['manageposts_topic_settings_submit'] = 'Salvează';

$txt['removeNestedQuotes'] = 'Elimină citatele unele în altele cand se scrie';
$txt['enableEmbeddedFlash'] = 'Activează flash în mesaje';
$txt['enableEmbeddedFlash_warning'] = 'iţi asumi un risc de securitate!';
$txt['enableSpellChecking'] = 'Activează verificare literară';
...
$txt['enableStickyTopics'] = 'Activează mesaje importante (sticky)';
$txt['enableParticipation'] = 'Activează iconul de participare';
$txt['oldTopicDays'] = 'Timp maxim după care mesajul este avertizat ca fiind vechi pentru raspunsuri';
$txt['oldTopicDays_zero'] = '0 pentru a dezactiva';
$txt['defaultMaxTopics'] = 'Numarul de subiecte pe pagina principală';
$txt['defaultMaxMessages'] = 'Numarul de mesaje pe pagina unui subiect';
$txt['hotTopicPosts'] = 'Numar de mesaje pentru un subiect interesant';
$txt['hotTopicVeryPosts'] = 'Numar de mesaje pentru un subiect foarte interesant';
$txt['enableAllMessages'] = 'Numarul maxim de mesaje pentru care este permisă afişarea &quot;integrală&quot; a subiectului';
$txt['enableAllMessages_zero'] = '0 pentru niciodata &quot;integral&quot;';
$txt['enablePreviousNext'] = 'Activează legaturile mesaj următor/anterior';

$txt['not_done_title'] = 'Nu este gata înca!';
$txt['not_done_reason'] = 'Pentru a împiedica supraîncarcarea serverului, procesul a fost temporat întrerupt. Ar trebui să continue automat în cateva secunde.  Daca nu click mai jos.';
...
$txt['utf8_title'] = 'Converteşte baza de date si datele înscrise în ea la UTF-8';
...
<ul>
	<li>Conversia caracterelor poate fi <em>dăunătoare</em> pentru datele tale! Asigură-te că ai un back-up foarte recent al bazei de date înainte de a începe <i>before</i> conversia.</li>
...
$txt['utf8_detected_charset'] = 'Având la bază fişierele de limba implicite (\'%1$s\'), setul de caractere pentru datele tale va fi cel mai probabil \'%2$s\'.';
