...
function template_main()
{
	...
	if (isset($context['boards']) && (!empty($options['show_children']) || $context['start'] == 0))
	{
		...
		<table width="100%" cellspacing="0" cellpadding="0">
			<tr>
				<td class="catbg_l"></td>
				<td class="catbg" height="30px">', $txt['parent_boards'], '</td>
				<td class="catbg_r"></td>
			</tr>
		</table>
		<table class="tborder" cellpadding="5" width="100%" style="margin-bottom: 3ex; ', $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? ' width: 100%;' : '', '">';
		foreach ($context['boards'] as $board)
		{
			echo '
			<tr>
				<td valign="middle" ' , !empty($board['children']) ? 'rowspan="2"' : '' , ' class="windowbg" width="6%" align="center"><a href="', $scripturl, '?action=unread;board=', $board['id'], '.0">';
  ...
  //For the stick/nonstick listings...
		...
		foreach ($context['topics'] as $topic)
		{
			...
			echo '
							<small id="pages' . $topic['first_post']['id'] . '">', $topic['pages'], '
							<br />
							by ', $topic['first_post']['member']['link'], '</small>
						</td>
