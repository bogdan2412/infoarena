...
function template_main()
{
	...
	{
		echo '
		<table width="100%" cellpadding="0" cellspacing="0" style="margin-top: ' , $first ? '5px;' : '1ex;' , '' , $context['browser']['needs_size_fix'] && !$context['browser']['is_ie6'] ? 'width: 100%;' : '', '"><tr>
		<td class="catbg_l" height="30px"></td>
		<td class="catbg">';
		$first = false;
	...
	<div class="tborder">
		...
		echo '
		<div style="background:Black; height:4px;"></div>
	</div>';
	}
	...
	echo '<br />
		...
		<td width="5px"><img src="', $settings['images_url'], '/nav_l.gif" alt=""/></td>
		<td id="infocenter" style="padding: 6px; vertical-align: middle; text-align: center; ">
		...
		<td width="5px"><img src="', $settings['images_url'], '/nav_r.gif" alt="" /></td>
		</tr></table>
