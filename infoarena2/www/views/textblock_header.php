...
<li><?= format_link_access(url_textblock_history($textblock['name']), 'Vezi istoria', 'i') ?></li>
<?php } ?>
...
<li><?= format_link_access(url_attachment_new($textblock['name']), 'Ataseaza fisier', 'a') ?></li>
<?php } ?>
